...
import { up as up0037 } from "./migrations/0037_sync_run_updated_at";
...
import { up as up0042 } from "./migrations/0042_provenance_ai_confidence";
import { up as up0043 } from "./migrations/0043_image_name_seed";
import { up as up0044 } from "./migrations/0044_exposure_seed";
import { up as up0045 } from "./migrations/0045_reap_orphaned_syncs";
import { up as up0046 } from "./migrations/0046_account_kind";
import { up as up0047 } from "./migrations/0047_weekly_digest";
import { up as up0048 } from "./migrations/0048_digest_runs";
import { up as up0049 } from "./migrations/0049_lambda_commit_seed";
import { up as up0050 } from "./migrations/0050_incidents";
import { up as up0051 } from "./migrations/0051_org_alert_settings";
import { up as up0052 } from "./migrations/0052_jira";
import { up as up0053 } from "./migrations/0053_pr_implements_seed";
import { up as up0054 } from "./migrations/0054_org_settings";
import { up as up0055 } from "./migrations/0055_fk_index_hygiene";
...
import { up as up0070 } from "./migrations/0070_clear_unretained_snapshots";
...
const MIGRATIONS: ReadonlyArray<{ version: string; statements: string[] }> = [
  ...
  { version: "0037_sync_run_updated_at", statements: up0037 },
  ...
  { version: "0042_provenance_ai_confidence", statements: up0042 },
  { version: "0043_image_name_seed", statements: up0043 },
  { version: "0044_exposure_seed", statements: up0044 },
  { version: "0045_reap_orphaned_syncs", statements: up0045 },
  { version: "0046_account_kind", statements: up0046 },
  { version: "0047_weekly_digest", statements: up0047 },
  { version: "0048_digest_runs", statements: up0048 },
  { version: "0049_lambda_commit_seed", statements: up0049 },
  { version: "0050_incidents", statements: up0050 },
  { version: "0051_org_alert_settings", statements: up0051 },
  { version: "0052_jira", statements: up0052 },
  { version: "0053_pr_implements_seed", statements: up0053 },
  { version: "0054_org_settings", statements: up0054 },
  { version: "0055_fk_index_hygiene", statements: up0055 },
  ...
  { version: "0070_clear_unretained_snapshots", statements: up0070 },
];
