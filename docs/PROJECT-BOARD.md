...
- 🏗️ Build: **F1 ✅ + F2 ✅ COMPLETE** (Phase F done). **Now in Phase I (Ingest):** I1 (AWS crawler) ∥ I2 (GitHub crawler) implement the frozen SDK (`docs/06`/`07`). **I1.1 ✅** foundation · **I1.2 ✅** AssumeRole + verify/degraded · **I1.3 ✅** 14 service modules (pure normalize/observedEdges/signals, every observed-edge type, golden fixtures). Next: I1.4 (live discover/fetchDetail + rate-limit/retry/pagination + incremental + wire into runner/registry/API).
