...
- 🏗️ Build: **F1 Foundation COMPLETE ✅**; **F2 IN PROGRESS** — F2.1–F2.6, F2.8 ✅ (schema, connector-sdk, graph schema, staged sync runner [EXIT met], queue/worker runtime, secrets broker, connection API). **Only F2.7 (Supabase Storage snapshots) remains.**
