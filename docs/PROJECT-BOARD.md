...
- 🏗️ Build: **F1 Foundation COMPLETE ✅** — F1.1 ✅, F1.2 CI ✅, F1.3 shells ✅, F1.4 DB+RLS ✅, F1.5 Supabase Auth ✅, F1.6 org/RBAC/memberships/invitations ✅, F1.7 tenant-isolation CI Postgres job ✅. **Next milestone: F2** (per `docs/15` roadmap: F1 → F2 → I1∥I2 → …).
