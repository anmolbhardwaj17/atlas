...
- 🏗️ Build: **F1 in progress** — F1.1 ✅, F1.2 CI ✅, F1.3 shells ✅, F1.4 DB+RLS ✅, F1.5 Supabase Auth ✅ (live Google login verified end-to-end); next **F1.6** (org / RBAC / memberships / invitations)
